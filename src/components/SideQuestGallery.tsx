  ...
  return (
    <>
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        {sideQuests.gallery.map((image, index) => (
          <button
            aria-label={`Open ${image.alt}`}
            className="group overflow-hidden rounded-lg border border-black/10 bg-white shadow-sm transition hover:-translate-y-1 hover:border-emerald-600/30 dark:border-white/10 dark:bg-white/8"
            key={image.src}
